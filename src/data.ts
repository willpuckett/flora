// Very directly from https://github.com/Plazide/fauna-gql-upload/blob/master/src/util/createOrUpdateData.ts.
import { DataResource } from 'npm:fauna-gql-upload/types.ts'
import { client, q } from './util.ts'

/** Creates or update domain data. */
export function createOrUpdateData(resource: DataResource) {
